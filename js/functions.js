...
Array.prototype.unique = function uniqueArray() {
  return [...[...new Set(this.filter(k => typeof k == "object").map(o => JSON.stringify(o)))]
    .map(s => JSON.parse(s)),
    ...new Set(this.filter(k => typeof k !== "object"))
  ]
}
